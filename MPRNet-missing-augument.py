...
class SAM(nn.Module):
    def __init__(self, in_channels,attention=1):
        super(SAM,self).__init__()
...
class Encoder(nn.Module):
    def __init__(self, n_feat, kernel_size, reduction, act, bias, scale_unetfeats, csff):
        ...
        feature_num_2 = 96
        feature_num_x2 = 256
        self.mem_rep = MemModule(n_feat, scale_unetfeats, shrink_thres=0.0025)
...
class MPRNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=40, scale_unetfeats=20, scale_orsnetfeats=16, num_cab=8, kernel_size=3, reduction=4, bias=False):
        ...
        self.sam12 = SAM(in_c, out_c)
        self.sam23 = SAM(in_c, out_c)
